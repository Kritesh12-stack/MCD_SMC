        ...
        <div>
            ...
            <div className="px-4">
                ...
                {loading ? (
                    ...
                    <div className="w-[70%] rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">{error}</div>
    ...
    return (
        <div className="w-[70%] border rounded-xl bg-white px-5 py-4 border-[#E8E8E8]">
            ...
            <div className="flex justify-between items-center mt-3">
                <p className="text-xs text-[#888]">{sourceLabel(item)}</p>
                <div className="flex items-center gap-1.5">
                    ...
                    <span className={`text-sm font-medium ${config.textColor}`}>{readableType(item.type)}</span>
                </div>
                <button
                    type="button"
                    onClick={onClick}
